                    ...
                    <form action="{{ route('productvariant.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="mb-4">
                            <label for="color_name"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Color Name
                                <span class="text-red-500">*</span></label>
                            <input type="text" id="color_name" name="color_name"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Masukan Color Name disini ..."
                                oninput="this.value = this.value.toUpperCase();" />
                        </div>
                        <div class="mb-4">
                            <label for="color_code"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Color Code
                                <span class="text-red-500">*</span></label>
                            <input type="text" id="color_code" name="color_code"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Masukan Color Code disini ..."
                                oninput="this.value = this.value.toUpperCase();" />
                        </div>
