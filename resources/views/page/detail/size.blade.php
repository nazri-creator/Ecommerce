<x-app-layout>
    ...
    <div class="py-8">
        <div class="mx-auto max-w-2xl sm:px-6 lg:px-8">
            ...
            {{-- Back Button --}}
            <div class="mb-4">
                <a href="{{ route('product.show', $product_id) }}"
            ...
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-xl">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-base font-semibold text-gray-700 dark:text-gray-200">Form Tambah Ukuran</h3>
                </div>
                ...
                <div class="p-6">
                    <form action="{{ route('productsize.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                <label for="size_name" class="block mb-1.5 text-sm font-medium text-gray-700 dark:text-gray-300">
